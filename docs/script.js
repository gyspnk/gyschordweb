...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function getChordFontSizeRem() {
    ...
    // Angka 0.78 adalah konstanta aproksimasi komparasi tinggi font partitur PDF dengan CSS Rem (Diturunkan dari 0.95 agar lebih compact)
    const adaptiveBase = 0.78 * pdfScale; 
    
    const size = adaptiveBase * (chordUiPrefs.fontOverridePercent / 100);
    // Batasan diperlebar (max 20) agar tetap tampil benar di resolusi monitor yang sangat raksasa
